...
export class IntroExplanation extends Component {
  ...
  render() {
    return (
      ...
      <Divider />
      <div className="Explanation-center">
        <p> <strong>ADVerse</strong> is the first to bring adversarial example generation and dynamic visualization to the browser for real-time exploration, and we invite developers and researchers to contribute to our growing library of attack vectors. </p>
      </div>
      </div>
    );
  }
